...
- (void)pickMediaFromSource:(UIImagePickerControllerSourceType)sourceType
{
    ...
    if ([UIImagePickerController isSourceTypeAvailable:sourceType] && [mediaTypes count] > 0) {
        ...
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Error accessing media" message:@"Device doesn't suport that media source." delegate:nil cancelButtonTitle:@"Draft!" otherButtonTitles:nil];
        [alert show];
    }
}
